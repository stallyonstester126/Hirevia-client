        ...
        <div className="w-full md:w-[56%] bg-white p-8 sm:p-10 lg:p-12 flex flex-col justify-center">
          <div className="max-w-[380px] w-full mx-auto space-y-6">
            ...
            <div>
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2.5 py-2.5 px-4 border border-slate-200 hover:border-slate-300 rounded-xl bg-white hover:bg-slate-50 text-slate-700 font-semibold text-xs sm:text-sm shadow-sm transition duration-150 cursor-pointer"
              >
